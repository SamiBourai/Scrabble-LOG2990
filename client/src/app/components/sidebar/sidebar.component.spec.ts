...
describe('SidebarComponent', () => {
    ...
    it('endTurn ',()=>{
        ...
        component['endTurn'](cmd,points);
        jasmine.clock().tick(1000);
        expect(spy).toHaveBeenCalled();
    });

    it('endTurn else errorMessage ',()=>{
        const cmd = 'placer';
        const points = 15;
        component.errorMessage = '';
        component['userService'].playMode = 'dsds';
        spyOn<any>(component,'updateMessageArray')
         const spy = spyOn<any>(component['userService'],'updateScore');
        component['endTurn'](cmd,points);
         expect(spy).toHaveBeenCalled();
    ...
    it('endTurn else ',()=>{
        ...
        spyOn<any>(component,'updateMessageArray')
        component['endTurn'](cmd,points);
         expect(component.typeArea).toContain(' (la validation du mot a échoué)')

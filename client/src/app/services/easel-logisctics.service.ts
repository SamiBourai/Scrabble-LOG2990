...
import { BOX, DEFAULT_HEIGHT, DEFAULT_WIDTH, HAND_POSITION_START, LEFTSPACE, TOPSPACE } from '@app/constants/constants';
...
export class EaselLogiscticsService {
  ...
  placeEaselLetters(lett: Letter): void {
    ...
    img.onload= () => {
      ...
      this.gridContext.drawImage(img,this.pos.pop() as number, TOPSPACE + DEFAULT_HEIGHT + TOPSPACE / 2 ,DEFAULT_WIDTH / BOX,DEFAULT_HEIGHT / BOX)
    }
  }

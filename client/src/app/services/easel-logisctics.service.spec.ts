...
describe('EaselLogiscticsService', () => {
    ...
    // const easel: Easel = { index: 0, letters: A };
    ...
    // it('should return letter on index on getLetterFromEasel', () => {
    //     service.occupiedPos = [true, true, true, true, true, true, true];
    //     spyOn(service.gridContext, 'clearRect').and.stub();
    //     const letter = service.getLetterFromEasel(1);
    //     expect(letter.charac).toBe(service.easelLetters[1].letters.charac);
    // });
});

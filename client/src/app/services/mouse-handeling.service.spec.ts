...
describe('MouseHandelingService', () => {
    ...
    beforeEach(() => {
        ...
        // const easel = service['userService'].getPlayerEasel();
    ...
    it('cancelByClick', () => {
        const mouseEvent = { offsetX: 300, offsetY: 850, button: MouseButton.Left } as MouseEvent;
        service.easelClicked(mouseEvent);
        service.lettersToSwapByClick = [A];
        // let x = true;
    ...
    it('tempCommand', () => {
        const i = service.tempCommand;
        expect(i).toEqual(service.commandObs);
    });
});

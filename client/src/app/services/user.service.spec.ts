...
fdescribe('UserService', () => {
    ...
    // it('test isGameOver, expect easel and reserve 0 ', () => {
    //     reserveService.reserveSize = 0;
    //     easelLogiscticsService.occupiedPos == [false, false, false, false, false, false, false];
    //     expect(userService.isGameOver()).toBeTrue();
    // });
});

 ...
 */
@NgModule({
    declarations: [AppComponent, GamePageComponent, MainPageComponent, MaterialPageComponent, PlayAreaComponent, SidebarComponent, NameSoloComponent, ModalScrableClassiqueComponent],
